...
/*
 * JC8012P4A1 single-cell Li-ion monitoring.  The board routes BAT+ through a
 * 68k/100k resistor divider to ESP32-P4 GPIO52, so the ADC sees ~59.5% of the
 * battery voltage.  Web Management can override the multiplier, critical
 * threshold, and numeric-percentage display without recompiling.
 */
...
#endif
#ifndef BATTERY_MULTIPLIER_MIN
#define BATTERY_MULTIPLIER_MIN 1.400f
#endif
#ifndef BATTERY_MULTIPLIER_MAX
#define BATTERY_MULTIPLIER_MAX 2.000f
#endif
#ifndef BATTERY_DEFAULT_SHOW_PERCENT
#define BATTERY_DEFAULT_SHOW_PERCENT 1
#endif
#ifndef BATTERY_DEFAULT_CRITICAL_PERCENT
#define BATTERY_DEFAULT_CRITICAL_PERCENT 10U
#endif
...
#endif
#ifndef BATTERY_VALID_MIN_MV
#define BATTERY_VALID_MIN_MV 2800U
#endif
#ifndef BATTERY_VALID_MAX_MV
